...
import { BookOpen, Download, Heart, Share2, ArrowLeft, Lock } from 'lucide-react';
...
const BookDetailsPage = () => {
    ...
    const book = {
        ...
        pages: 120, // Simulated total pages
        category: "Computer Science",
        rating: 4.8,
        imageUrl: "https://www.amazon.com/Introduction-Algorithms-3rd-MIT-Press/dp/0262033844"
    };
        ...
        return (
            <div className="fixed inset-0 z-[60] bg-black text-white overflow-y-auto">
                <div className="sticky top-0 bg-black/90 backdrop-blur-md border-b border-white/10 p-4 flex justify-between items-center">
                    <h2 className="font-bold truncate max-w-md">{book.title}</h2>
                ...
                <div className="max-w-3xl mx-auto py-12 px-6 space-y-12">
                    {pages.map((page) => {
                        const isLocked = !userId && page.num > 10;
                        ...
                        return (
                            <div key={page.num} className="relative bg-[#111] p-8 min-h-[500px] shadow-2xl rounded-sm">
                                ...
                                <div className={isLocked ? "blur-md select-none opacity-30 pointer-events-none" : ""}>
                                    <h3 className="text-2xl font-serif mb-6 text-gray-300">Chapter {page.num}</h3>
                                ...
                                {isLocked && (
                                    <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
                                        ...
                                        <p className="text-gray-400 mb-6 text-center max-w-xs">
                                            Sign in to continue reading this book and access all {book.pages} pages.
                                        </p>
                                        <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    <div className="md:col-span-2 space-y-8">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4">
                            ...
                            <div className="p-4 bg-[#111] rounded-2xl border border-white/5">
                                <p className="text-xs text-gray-500 uppercase tracking-widest mb-1">Released</p>
